...
class FloatingWindow(tk.Toplevel):
    def __init__(self, *args, **kwargs):
        ...
        topl=15
        width=(5*bw)+(6*bp)
        height=(2*bh)+(4*bp)+topl
        alignstr = '%dx%d+%d+%d' % (width, height, 500, 100)
        ...
        self.grip["bg"] = bg
        self.grip.place(x=bxc,y=byc,width=(bw*4)+(bp*3),height=topl)
        ...
        GButton_861["command"] = self.GButton_861_command
        ...
        GButton_914["command"] = self.GButton_914_command
        ...
        bxc+=(bw*2)+(bp*2)
        GButton_834=tk.Button(self)
        GButton_834["bg"] = bg
        GButton_834["font"] = ft
        GButton_834["fg"] = fg
        GButton_834["text"] = "De"
        GButton_834["relief"] = relief
        GButton_834.place(x=bxc,y=byc,width=bw,height=bh)
